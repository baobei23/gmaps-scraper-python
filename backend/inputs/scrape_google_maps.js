 ...
 * @typedef {import('../../frontend/node_modules/botasaurus-controls/dist/index').FileTypes} FileTypes
 */
...
function getInput(controls) {
  controls
    ...
    .switch("use_categories", {
      ...
      defaultValue: false,
      helpText:
        "Jika diaktifkan, pencarian akan dilakukan berdasarkan semua kategori Google Maps untuk lokasi yang ditentukan di bawah ini.",
    })
    .text("category_location", {
      ...
      isDisabled: (data) => !data.use_categories,
      disabledMessage:
        'Diaktifkan hanya jika "Gunakan Pencarian Kategori" aktif.',
    ...
    .number("max_categories", {
      ...
      helpText:
        "Batasi jumlah kategori yang akan digunakan untuk pencarian. Biarkan kosong untuk menggunakan semua kategori.",
      min: 1,
